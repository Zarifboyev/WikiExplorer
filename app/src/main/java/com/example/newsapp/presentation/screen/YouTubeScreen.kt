...
class YouTubeScreen : Fragment(R.layout.screen_youtube) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (CONST.YOUTUBE_API_KEY.startsWith("YOUR_API_KEY")) {
            ...
            childFragmentManager.beginTransaction()
                .add(R.id.youtube_container, YouTubeRecyclerViewFragment.newInstance(youtubeDataApi, YOUTUBE_PLAYLISTS))
                .commit()
        }
    }
