package com.z99a.wikipedia.vikipediya

object CONST {

    const val PREFS_NAME = "FavoritePlacesPrefs"
    const val KEY_FAVORITE_PLACES = "favorite_places"

//    var IS_IN_FOREIGN_LANGUAGE_MODE = false
